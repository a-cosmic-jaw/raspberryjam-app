...
package eu.symmetrysought.raspberryjam.kts.fromFile

import eu.symmetrysought.raspberryjam.kts.fromFile.SimpleScript
import java.io.File
...
fun main(filename: String): EvaluationResult {
